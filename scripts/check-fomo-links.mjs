...
const pages = ['campus/landing.html','campus/directory.html','campus/manual.html','greekwars/invite.html','greekwars/refer.html','greekwars/onboard.html','campus/visit.html'];
